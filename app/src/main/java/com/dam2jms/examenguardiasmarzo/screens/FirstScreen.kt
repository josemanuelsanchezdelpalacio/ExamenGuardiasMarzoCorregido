package com.dam2jms.examenguardiasmarzo.screens
...
@Composable
fun firstScreenContent(modifier: Modifier = Modifier, mvvm: ViewModelFirstScreen, navController: NavHostController, uiState: UiState) {
